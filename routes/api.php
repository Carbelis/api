...
Route::get('v1/all/producto','App\Http\Controllers\ProductoController@index');//mostrar todos los registros
Route::post('v1/save/producto','App\Http\Controllers\ProductoController@store');//Crear registros
Route::put('v1/edit/producto/{id}','App\Http\Controllers\ProductoController@update');//actualizar registro por id
Route::delete('v1/delete/producto/{id}','App\Http\Controllers\ProductoController@destroy');//eliminar registro por id
